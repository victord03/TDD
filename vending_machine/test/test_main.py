...
class TestBaseFunctionality:
    ...
    @param_list_items
    def test_give_a_list_with_the_name_of_all_available_items(self, item1, item2, item3, stock_amount, result):
        machine_instance = setup()
    ...
    def test_check_all_stock(self, item1, item2, item1_stock_amount, item2_stock_amount, result):
        machine_instance = setup()
    ...
    @param_sales_log
    def test_sold_item_logged(self, item1, item2, item3, sales1, sales2, sales3, result):
        machine_instance = setup()
        stock_amount = 20
...
class TestHandleExceptions:
    ...
    def test_adding_zero_or_negative_stock_amount_returns_value_error(self, item, stock_amount, result):
        machine_instance = setup()
